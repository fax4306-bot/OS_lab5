...
__panic(const char *file, int line, const char *fmt, ...) {
  ...
  80003a:	5c250513          	addi	a0,a0,1474 # 8005f8 <main+0xae>
__panic(const char *file, int line, const char *fmt, ...) {
  ...
  80005a:	5c250513          	addi	a0,a0,1474 # 800618 <main+0xce>
...
exit(int error_code) {
  ...
  80012a:	4fa50513          	addi	a0,a0,1274 # 800620 <main+0xd6>
...
printnum(void (*putch)(int, void*), void *putdat,
  ...
  80017e:	4be78793          	addi	a5,a5,1214 # 800638 <main+0xee>
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap) {
  ...
  8001da:	496a8a93          	addi	s5,s5,1174 # 80066c <main+0x122>
        case 'e':
            err = va_arg(ap, int);
            if (err < 0) {
                err = -err;
  ...
  8001e2:	6aab8b93          	addi	s7,s7,1706 # 800888 <error_string>
        while ((ch = *(unsigned char *)fmt ++) != '%') {
  ...
  800438:	23460613          	addi	a2,a2,564 # 800668 <main+0x11e>
  ...
  80044a:	21260613          	addi	a2,a2,530 # 800658 <main+0x10e>
  ...
  80045c:	1f840413          	addi	s0,s0,504 # 800650 <main+0x106>
  ...
  8004e6:	16e40413          	addi	s0,s0,366 # 800650 <main+0x106>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
  ...
  8004fc:	159a0a13          	addi	s4,s4,345 # 800651 <main+0x107>
...
main(void) {
  ...
  800550:	40450513          	addi	a0,a0,1028 # 800950 <error_string+0xc8>
main(void) {
  800554:	e406                	sd	ra,8(sp)
    cprintf("Making sure bss works right...\n");
  800556:	b4dff0ef          	jal	ra,8000a2 <cprintf>
    int i;
    for (i = 0; i < ARRAYSIZE; i ++) {
  80055a:	00001597          	auipc	a1,0x1
  80055e:	aa658593          	addi	a1,a1,-1370 # 801000 <bigarray>
    cprintf("Making sure bss works right...\n");
  800562:	87ae                	mv	a5,a1
    for (i = 0; i < ARRAYSIZE; i ++) {
  800564:	4681                	li	a3,0
  800566:	00100637          	lui	a2,0x100
  80056a:	a029                	j	800574 <main+0x2a>
  80056c:	2685                	addiw	a3,a3,1
  80056e:	0791                	addi	a5,a5,4
  800570:	00c68f63          	beq	a3,a2,80058e <main+0x44>
        if (bigarray[i] != 0) {
  800574:	4398                	lw	a4,0(a5)
  800576:	db7d                	beqz	a4,80056c <main+0x22>
            panic("bigarray[%d] isn't cleared!\n", i);
  800578:	00000617          	auipc	a2,0x0
  80057c:	3f860613          	addi	a2,a2,1016 # 800970 <error_string+0xe8>
  800580:	45b9                	li	a1,14
  800582:	00000517          	auipc	a0,0x0
  800586:	40e50513          	addi	a0,a0,1038 # 800990 <error_string+0x108>
  80058a:	a9dff0ef          	jal	ra,800026 <__panic>
  80058e:	00001717          	auipc	a4,0x1
  800592:	a7270713          	addi	a4,a4,-1422 # 801000 <bigarray>
        }
    }
    for (i = 0; i < ARRAYSIZE; i ++) {
  800596:	4781                	li	a5,0
  800598:	001006b7          	lui	a3,0x100
        bigarray[i] = i;
  80059c:	c31c                	sw	a5,0(a4)
    for (i = 0; i < ARRAYSIZE; i ++) {
  80059e:	2785                	addiw	a5,a5,1
  8005a0:	0711                	addi	a4,a4,4
  8005a2:	fed79de3          	bne	a5,a3,80059c <main+0x52>
    }
    for (i = 0; i < ARRAYSIZE; i ++) {
  8005a6:	4681                	li	a3,0
  8005a8:	00100737          	lui	a4,0x100
  8005ac:	a029                	j	8005b6 <main+0x6c>
  8005ae:	2685                	addiw	a3,a3,1
  8005b0:	0591                	addi	a1,a1,4
  8005b2:	02e68063          	beq	a3,a4,8005d2 <main+0x88>
        if (bigarray[i] != i) {
  8005b6:	419c                	lw	a5,0(a1)
  8005b8:	fed78be3          	beq	a5,a3,8005ae <main+0x64>
            panic("bigarray[%d] didn't hold its value!\n", i);
  8005bc:	00000617          	auipc	a2,0x0
  8005c0:	3e460613          	addi	a2,a2,996 # 8009a0 <error_string+0x118>
  8005c4:	45d9                	li	a1,22
  8005c6:	00000517          	auipc	a0,0x0
  8005ca:	3ca50513          	addi	a0,a0,970 # 800990 <error_string+0x108>
  ...
  8005d6:	3f650513          	addi	a0,a0,1014 # 8009c8 <error_string+0x140>
  8005da:	ac9ff0ef          	jal	ra,8000a2 <cprintf>
    cprintf("testbss may pass.\n");
  8005de:	00000517          	auipc	a0,0x0
  8005e2:	42250513          	addi	a0,a0,1058 # 800a00 <error_string+0x178>
  ...
  8005ea:	4501                	li	a0,0
    bigarray[ARRAYSIZE + 1024] = 0;
  8005ec:	00402797          	auipc	a5,0x402
  8005f0:	a007aa23          	sw	zero,-1516(a5) # c02000 <bigarray+0x401000>
    exit(0);
  8005f4:	b2bff0ef          	jal	ra,80011e <exit>
